...
vg.parse.data = function(spec, callback) {
  ...
  // !!!!@rudolph sept 2 2014
  console.log("\n##### vega: spec.marks = " + spec.marks);
  console.log("\n##### vega: typeof spec.marks = " + typeof spec.marks);
  console.log("\n##### vega: Array.isArray(spec.marks) = " + Array.isArray(spec.marks));
...
function vg_hLegendLabels() {
  ...
  prototype.initialize = function(el) {
    ...
    // **** !!!!!! modified library !!!!! *****
    // add div container
    // deletion by Rudolph Aug 12 2014 - avoid generated svg
    // from being wrapped by <div class='vega' style='position:relative'>
    // NOTE: selection.node() returns first node in the selection
    this._el = el = d3.select(el).node();  // .node(); added
//      .append("div")              // 4 lines commented out
//      .attr("class", "vega")
