...
angular.module('app').directive("i3dSphere", 
  ['$templateCache', 'Camera3D', function($templateCache, Camera3D){
  "use strict";

  console.log("\ni3d-sphere-directive running! ");
  ...
  return {
    ...
    link: function($scope, elem, attrs){
      ...
      console.log("\ni3d-sphere-directive link-f running!");
      ...
      // tmp - diagnostics!!!
//      console.log("i3d-sphere-directive 'attrs' properties:");
//      for(var p in attrs){
//        if(p.toString().match(/^i3d[a-zA-z]+/)){
//          console.log("sphere attrs." + p + " = " + attrs[p.toString()]);
//        }else{
//          console.log("sphere attrs has non xmlns-i3d property: " + p);
//        }
//      }
      ...
      */
      if(attrs.i3dTextureurl){
        texture = THREE.ImageUtils.loadTexture(attrs.i3dTextureurl, THREE.UVMapping, function(){       
          ...
          //console.log("sphere texture = " + texture);
          //console.log("sphere texture.magFilter = " + texture.magFilter);
            
          // shaderMaterial - vsh/fsh interferes with billboard transparency(?)
          //shaderMaterial = new THREE.MeshLambertMaterial({ map : texture });
          //console.log("sphere meshLambertMaterial = " + shaderMaterial);    
          ...
          console.log("sphere shaderMaterial = " + shaderMaterial);    
        ...
        console.log("sphere color = " + attrs.i3dColor);
        console.log("sphere transp = " + transparent);
      ...
      elem.on("$destroy", function() {
        console.log("SPHERE DESTROYED! id = " + attrs.id + " sph = " + sphere);
